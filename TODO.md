# EDITOR 
## fast-fixes:
- DONE: when you press find image the scroll bar to start at the top
...
- DONE: more info with regards to actions 
- DONE: print 
- DONE: upload image auto resize 
- DONE: write action copy issue
- DONE: actions add space
...
- DONE: popups only open once 
- DONE: double click opens the editor
- DONE: button to add new board

## bugs:
- DONE: updates from one tab don't properly propergate to another (try drag folder)
